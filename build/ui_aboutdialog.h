...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Ganjacoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Ganjacoin</b> version", 0));
...
"Copyright \302\251 2017 The Ganjacoin developers", 0));
